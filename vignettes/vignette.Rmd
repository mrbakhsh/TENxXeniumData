...
are integrated into the metadata information of the constructed object,
...
* [Human Pancreas: 10x Genomics Xenium In Situ (Tiny Subset)](https://www.10xgenomics.com/resources/datasets/human-pancreas-preview-data-xenium-human-multi-tissue-and-cancer-panel-1-standard)
...
datasets into your R session, representing them as objects of the `SpatialExperiment` or `SpatialFeatureExperiment` classes.

There are two distinct approaches available for loading the datasets: 
one involves utilizing named accessor functions, while the other entails 
querying the ExperimentHub database for retrieval.
